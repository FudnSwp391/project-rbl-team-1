...
import { EXAM_DETAIL_STRINGS, type CommentFormValues } from '@/features/exam-detail/types'
...
function ExamDetailPageContent() {
  ...
  return (
    <div className="exam-detail-page">
      <SubscriptionHeader
        userEmail={EXAM_DETAIL_STRINGS.MOCK_USER.EMAIL}
        userInitial={EXAM_DETAIL_STRINGS.MOCK_USER.INITIAL}
        notificationCount={EXAM_DETAIL_STRINGS.MOCK_USER.NOTIFICATION_COUNT}
        streakCount={EXAM_DETAIL_STRINGS.MOCK_USER.STREAK_COUNT}
      ...
      <div className="exam-detail-page__body">
        ...
        <main className="exam-detail-page__main">
          ...
          <section className="exam-detail-page__question-area">
            <ExamQuestionHeader examCode={data.examInfo.examCode} />
            ...
            <div className="exam-detail-page__content-grid">
              <div className="exam-detail-page__question-column">
                ...
                />
                <AiExplanationCard explanation={data.aiExplanation} />
              </div>
